...
function builtin() {
    ...
    fs.readdir(docs, function(err, files) {
        ...
        console.log();
        console.log('    - public module list'.magenta);
        console.log();
        console.log('    ' + public.join(', ').cyan);
        console.log();
        console.log('    - native module list (Node.js Black Edition)'.magenta);
        console.log();
        console.log('    ' + native.join(', ').cyan);
        console.log();
        console.log();
    });
}
